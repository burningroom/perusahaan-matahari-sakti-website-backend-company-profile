...
@php
    ...
    $variants = [
        ...
        'outline' => [
            'default' => 'border border-gray-300 hover:bg-gray-100 text-[var(--fg-2)] hover:text-gray-700 focus:ring-gray-200',
        ...
        'ghost' => [
            'default' => 'hover:bg-gray-100 text-[var(--fg-2)] hover:text-gray-700 focus:ring-gray-200',
...
wire:loading.attr="disabled" @endif
    {{ $attributes->merge([
        ...
        'class' => $classes,
    ]) }} @if($tooltip) data-tooltip="{{ $tooltip }}" @endif @if ($tooltipPosition)
