...
trait HandleResponseApi
{
     ...
     */
    public function sendSuccess($message, $title = null): JsonResponse
    {
        $response = [
            'success' => true,
            'title' => $title,
     ...
     * @return \Illuminate\Http\Response json()
     */
    public function sendResponse(mixed $data, $message, $pagination = null, $code = 200): JsonResponse
    {
        $response = [
            'success' => true,
            'message' => $message,
    ...
    public function sendErrorHandled(Exception|HandledException $e): Response
    {
        $message = match (true) {
    ...
    public function mappingResponsePaginate(LengthAwarePaginator $paginate): array
    {
        return [
